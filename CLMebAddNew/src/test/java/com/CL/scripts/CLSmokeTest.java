...
public class CLSmokeTest extends SooperTestNG
{
	@BeforeTest
	public void startreport()
	{	
		super.initPath("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Screenshots\\SmokTestReport.html");			
	}	
	...
	{		
		try
		{
			...
			ResultSet rs = smt.executeQuery("select * from Dependent where mbrid='"+MbrID+"'");			   			   
			
			while(rs.next())
			{
				String MbdDepID = rs.getString("MbdDepID");	
				System.out.println("MbrDepID - "+MbdDepID);	
				test.log(LogStatus.INFO, "MbrDepID - "+MbdDepID);
				String FirstName = rs.getString("Firstname");	
				System.out.println("Dep FirstName - "+FirstName);
				test.log(LogStatus.INFO, "Dep FirstName - "+FirstName);	
				String LastName = rs.getString("LastName");	
				System.out.println("Dep LastName - "+LastName);
				test.log(LogStatus.INFO, "Dep LastName - "+LastName);
				String RltnCode = rs.getString("RltnCode");	
				System.out.println("Relation - "+RltnCode);
				test.log(LogStatus.INFO, "Relation - "+RltnCode);				
	...
	{		
		...
		{		
			...
			FileInputStream fis = new FileInputStream("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Excelfiles\\CreateMember.xlsx"); 
			Workbook workbook = WorkbookFactory.create(fis);
			Sheet sheet = workbook.getSheet("Update Member");
			...
			while(rs.next())
			{
				...
				System.out.println("MbrDepID - "+MbrID);	
				test.log(LogStatus.INFO, "MbrID - "+MbrID);
				String FirstName = rs.getString("Firstname");	
				System.out.println("Meb FirstName - "+FirstName);
				test.log(LogStatus.INFO, "Meb FirstName - "+FirstName);	
				String MebLastName = rs.getString("LastName");	
				System.out.println("Meb LastName - "+MebLastName);
				test.log(LogStatus.INFO, "Meb LastName - "+MebLastName);								
			}		
	...
	public void testupdatedep()
	{
		try
		{
			...
			while(rs.next())
			{
				...
				System.out.println("Dep FirstName - "+FirstName);
				test.log(LogStatus.INFO, "Dep FirstName - "+FirstName);	
				String DepLastName = rs.getString("LastName");	
				System.out.println("Dep LastName - "+DepLastName);
				test.log(LogStatus.INFO, "Dep LastName - "+DepLastName);
				String RltnCode = rs.getString("RltnCode");	
				System.out.println("Relation - "+RltnCode);
				test.log(LogStatus.INFO, "Relation - "+RltnCode);				
			}	
	...
	public void testManualLetter()
	{
		try
		{
			...
			FileInputStream fis = new FileInputStream("E:\\Enrollment\\DCLatest\\Excelfiles\\CreateMember.xlsx"); 
			Workbook workbook = WorkbookFactory.create(fis);
	...
	{		
		try
		{
			test=extent.startTest("Member Cancellation");
			...
			if(MebRegsucess.contains("Email sent successfully."))			
			{
				test.log(LogStatus.PASS, MebRegsucess);
			...
			{
				test.log(LogStatus.FAIL, MebRegsucess);
				super.passfail("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Screenshots\\", "MemberCancellationFAIL.png");	
				shnew.getRow(3).getCell(3).setCellValue("Member should get cancel with success message like Record updated successfully.");
				shnew.getRow(3).getCell(4).setCellValue("O");			
			}
			...
			String MbrID = driver.findElement(By.id("MbrHdr_lblMemberId")).getText();
			Thread.sleep(10000);
			//driver.findElement(By.xpath("//a/img[@src='/CareLynx/images/logout.gif']")).click();
			Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
			System.out.println("Driver Loaded");			
			...
			while(rs.next())
			{
				String MbrSttsCode = rs.getString("MbrSttsCode");	
				System.out.println("Member Status - "+MbrSttsCode);	
				test.log(LogStatus.INFO, "Member Status - "+MbrSttsCode);												
			}	
	...
	{		
		try
		{
			test=extent.startTest("Member Re-Activation");
			driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
			//FileInputStream fis = new FileInputStream("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Excelfiles\\CreateMember.xlsx"); 
			...
			if(MebRegsucess.contains("Member re-activated successfully."))			
			{
				test.log(LogStatus.PASS, MebRegsucess);
				super.passfail("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Screenshots\\", "MemberREACTIVATEPASS.png");	
				shnew.getRow(3).getCell(3).setCellValue("Member should get Re-activate with success message like Member re-activated sucessfully.");
				shnew.getRow(3).getCell(4).setCellValue("P");
			}
			else
			{
				test.log(LogStatus.FAIL, MebRegsucess);
				super.passfail("C:\\Users\\raviv\\git\\AddMebCL\\CLMebAddNew\\Screenshots\\", "MemberREACTIVATEFAIL.png");	
	...
	{		
		try
		{
			...
			driver.findElement(By.linkText("General")).click();
			Thread.sleep(10000);			
			driver.findElement(By.linkText("Click here for Fulfillment")).click();
			Thread.sleep(10000);
			driver.findElement(By.linkText("Cancel Fulfillment Request")).click();
			Thread.sleep(5000);
